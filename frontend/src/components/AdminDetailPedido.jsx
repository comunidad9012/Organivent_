    ...
    <>
      ...
      <div className="flex flex-col md:flex-row gap-6 items-start">
        ...
        <div className="bg-white rounded-xl shadow-md p-4 border border-gray-100 md:w-1/3">
          ...
          <p className="flex items-start gap-2 text-sm text-gray-700 break-all leading-snug">
        ...
        <div className="bg-white rounded-xl shadow-md p-4 border border-gray-100 md:w-2/3">
