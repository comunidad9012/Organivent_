   ...
   <DropdownMenu>
    <DropdownMenuTrigger asChild>
      ...
      <DropdownMenuContent className="bg-white dark:bg-zinc-900  right-0 z-50  mt-2 w-48 origin-top-right rounded-md shadow-lg ring-1 ring-black/5">
        <DropdownMenuItem className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Tu perfil</DropdownMenuItem>
        <DropdownMenuItem className="border-bottom block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Configuración</DropdownMenuItem>
        <Logout />
      </DropdownMenuContent>
    </DropdownMenu>
